<div class="page-content">
    ...
    <div class="breadcrumbs">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Upload Model Suffixs</li>
        </ol>
        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="portlet light bordered inspection-add-form-portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i> Upload Model Suffixs Form
                    </div>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="model_suffixs_excel" class="control-label">Upload Model Suffixs:
                                            <span class="required">*</span>
                                        </label>
                                        <input type="file" name="model_suffixs_excel" class="required">
                                    </div>
                                </div>
                            </div>
