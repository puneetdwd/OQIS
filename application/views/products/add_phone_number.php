<div class="page-content">
    ...
    <div class="breadcrumbs">
        ...
        <ol class="breadcrumb">
            ...
            <li>
                <a href="<?php echo base_url()."products/phone_numbers/".$product['id']; ?>">
        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <div class="portlet light bordered checkpoint-add-form-portlet">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-reorder"></i> Phone Number Form - <?php echo $product['name']; ?>
                    </div>
                </div>
                ...
                <div class="portlet-body form">
                    <form role="form" class="validate-form" method="post">
                        ...
                        <div class="form-actions">
                            ...
                            <a href="<?php echo base_url().'products/phone_numbers/'.$product['id']; ?>" class="button white">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
