        ...
        <div class="wrapper text-center">
            <header>
                <div class="container">
                    ...
                    <div class="page-logo-text" style="text-align: center; font-size: 20px; margin-top: 34px; color: #C80541;">OQIS - Outgoing Quality Integrated System</div>
                </div>
            </header>
