        ...
        <div class="col-md-offset-2 col-md-8">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="btn btn-xs btn-outline btn-circle sbold red-thunderbird" data-confirm="Are you sure you want to mark checklist as <?php echo $product['checklist_active'] ? 'inactive' : 'active';?>?"
                            href="<?php echo base_url()."checklist/status/".($product['checklist_active'] ? 'inactive' : 'active' );?>">
                            <i class="fa fa-trash-o"></i> <?php echo $product['checklist_active'] ? 'Mark Inactive' : 'Mark Active';?>
                        </a>
