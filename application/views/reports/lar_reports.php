<div class="page-content">
    ...
    <div class="breadcrumbs">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Lar Reports</li>
        </ol>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portlet light bordered">
                        <div class="portlet-title">
                            <div class="caption">
                                <i class="fa fa-reorder"></i>LAR Report 
                            </div>
                            
                            <div class="actions" style="margin-top: 0px;">
                                <form action="<?php echo base_url()."reports/lar_report"?>" method="post" role="form">
                            ...
                            <?php } else { ?>
                                <div class="table-responsive">
                                    <table class="table table-hover table-bordered table-striped">
                                        <thead>
                                            <tr>
                                                <th colspan="2" class="text-center"> OQA LAR (%) </th>
