        ...
        <div class="col-md-12">
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    ...
                    <div class="actions">
                        <a class="button normals btn-circle" href="<?php echo base_url()."inspections/exclude_checkpoint_form"; ?>">
                        ...
                        <table class="table table-hover table-light" id="make-data-table">
                            ...
                            <tbody>
                                <?php foreach($excluded_checkpoints as $excluded_checkpoint) { ?>
                                    <tr>
                                        <?php if(!$this->product_id) { ?>
                                            <td><?php echo $excluded_checkpoint['product_name']; ?></td>
                                        <?php } ?>
                                        <td><?php echo $excluded_checkpoint['inspection_name']; ?></td>
                                        <td><?php echo str_replace(',', ', ', $excluded_checkpoint['model']); ?></td>
                                        <td><?php echo $excluded_checkpoint['checkpoints_nos']; ?></td>
                                        <td nowrap>
                                            <a class="button small gray" 
                                                href="<?php echo base_url()."inspections/exclude_checkpoint_form/".$excluded_checkpoint['id'];?>">
                                                <i class="fa fa-edit"></i> Edit
                                            </a>
                                            <a class="btn btn-outline btn-xs sbold red-thunderbird" data-confirm="Are you sure you want to this record?" 
                                                href="<?php echo base_url()."inspections/delete_exclude_checkpoint/".$excluded_checkpoint['id'];?>">
