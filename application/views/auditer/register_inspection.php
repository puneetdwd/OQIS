<div class="page-content">
    ...
    <div class="breadcrumbs">
        <h1>
            Product Inspection | Register Screen
        </h1>
        <ol class="breadcrumb">
            <li>
                <a href="<?php echo base_url(); ?>">Home</a>
            </li>
            <li class="active">Product Inspection</li>
        </ol>
                    ...
                    <form role="form" id="register-inspection-form" class="validate-form" method="post">
                        <div class="form-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group" id="register-inspection-inspection-error">
                                        <label class="control-label">Select Inspection:
                                            <span class="required"> * </span>
                                        </label>
                                                
                                        <select id="register-inspection-inspection" name="inspection_id" class="form-control required select2me"
                                            data-placeholder="Select Inspection" data-error-container="#register-inspection-inspection-error">
                                            <option value=""></option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="control-label" for="paired">&nbsp;</label>
                                        <div class="checkbox-list">
                                            <label class="checkbox-inline">
                                            <input type="checkbox" name="paired" value="true"> Add Another Serial No. </label>
                                        </div>
                                    </div>
                                </div>
